...
image_BGR = cv2.imread('/home/disorn/code_save/Project_Structure/core_program/yolo_part/yolo-camera/test1/fuse_image_bgremove_v2_1.png' , cv2.IMREAD_UNCHANGED)
#cv2.imshow('fir', image_BGR)
